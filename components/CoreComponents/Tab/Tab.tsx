                    ...
                    {tabList.map((tab) => (
                        <li className="mr-2" onClick={() => setActiveHandler(tab)}>
                            ...
                            ${ativetab?.id.toLowerCase() === tab.id.toLowerCase() ?
                                        "text-blue-600 border-b-2 border-blue-600 rounded-t-lg active  hover:text-blue-500" : "hover:border-gray-600 text-gray-600 hover:text-gray-900 border-transparent"}
                                    group`}
